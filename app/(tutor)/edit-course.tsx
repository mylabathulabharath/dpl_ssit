    ...
    try {
      if (id) {
        ...
        if (courseData) {
          ...
          setCategory(courseData.category || 'Development');
          setLanguage(courseData.language || 'English');
          setTrainerCredentials(courseData.trainerCredentials || '');
          setOutcomes(courseData.outcomes.length > 0 ? courseData.outcomes : ['']);
          setSelectedUniversityIds(courseData.university_ids || []);
          setSelectedBranchIds(courseData.branch_ids || []);
  ...
  const handleUpdateCourse = async () => {
    ...
    try {
      const courseData: CourseFormData = {
        ...
        thumbnail: thumbnail.trim() || demoThumbnails[0],
        category: category,
        language: language,
    ...
    >
      ...
      >
        ...
        <View style={[styles.header, Platform.OS === 'web' && styles.headerWeb]}>
          ...
          >
            {step === 'basics' ? 'Edit Course Basics' : 'Edit Course Structure'}
          </ThemedText>
          <View style={{ width: 40 }} />
        </View>
        ...
        >
          ...
          {step === 'basics' ? (
            ...
            <Animated.View entering={FadeInDown.duration(400)}>
              ...
              >
                Update topics and lessons to structure your course content.
              </ThemedText>
